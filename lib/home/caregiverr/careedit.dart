...
class CareEditScreen extends StatefulWidget {
  final String medicationId;
  final Map<String, dynamic> initialData;
  const CareEditScreen({
    required this.medicationId,
    required this.initialData,
    super.key});

  @override
  State<CareEditScreen> createState() => _CareEditScreenState();
}

class _CareEditScreenState extends State<CareEditScreen> {

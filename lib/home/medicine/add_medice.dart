...
class MedicineSchedule extends StatefulWidget {
  ...
  @override
  _MedicineScheduleState createState() => _MedicineScheduleState();
}
...
class _MedicineScheduleState extends State<MedicineSchedule> {
  ...
  void addMedication() async {
    ...
    String dynamicUnit = (medicineType == 'Syrup') ? 'ml' : 'Number of Pill';
    ...
    try {
      id1 = DateTime.now().millisecondsSinceEpoch.remainder(100000);
      id2 = (id1! + 1); // Ensuring uniqueness
      id3 = (id2! + 1); // Ensuring uniqueness
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            _textField(
              'Medicine Amount (${selectedMedicineType == 'Syrup' ? 'ml' : 'Number of Pill'})',
